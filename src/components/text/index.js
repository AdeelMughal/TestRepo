...
export const XXLTitle = ({style, onPress, children}) => {
  return (
    <Text style={[styles.xxlTitleStyle, style]} onPress={onPress}>
      {children}
    </Text>
  );
};
export const XLTitle = ({style, onPress, children}) => {
  return (
    <Text style={[styles.xlTitleStyle, style]} onPress={onPress}>
      {children}
    </Text>
  );
};
export const LargeTitle = ({style, onPress, children}) => {
  return (
    <Text style={[styles.largeTitleStyle, style]} onPress={onPress}>
      {children}
    </Text>
  );
};
export const MediumTitle = ({style, onPress, children}) => {
  return (
    <Text style={[styles.mediumTitleStyle, style]} onPress={onPress}>
      {children}
    </Text>
  );
};
export const SmallTitle = ({style, onPress, children}) => {
  return (
    <Text style={[styles.smallTitleStyle, style]} onPress={onPress}>
      {children}
    </Text>
  );
};
export const TinyTitle = ({style, onPress, children}) => {
  return (
    <Text style={[styles.tinyTitleStyle, style]} onPress={onPress}>
      {children}
    </Text>
  );
};
export const TinierTitle = ({style, onPress, children}) => {
  return (
    <Text style={[styles.tinierTitleStyle, style]} onPress={onPress}>
      {children}
    </Text>
  );
};
...
export const LargeText = ({style, onPress, children}) => {
  return (
    <Text style={[styles.largeTextStyle, style]} onPress={onPress}>
      {children}
    </Text>
  );
};
export const MediumText = ({style, onPress, children}) => {
  return (
    <Text style={[styles.mediumTextStyle, style]} onPress={onPress}>
      {children}
    </Text>
  );
};
...
export const SmallText = ({style, onPress, children}) => {
  return (
    <Text style={[styles.smallTextStyle, style]} onPress={onPress}>
      {children}
    </Text>
  );
};
export const TinyText = ({style, onPress, children}) => {
  return (
    <Text style={[styles.tinyTextStyle, style]} onPress={onPress}>
      {children}
    </Text>
  );
};
export const InputTitle = ({style, children}) => {
  return <Text style={[styles.inputTitleStyle, style]}>{children}</Text>;
};

export const ButtonTextRegular = ({style, children}) => {
  return <Text style={[styles.ButtonTextRegularStyle, style]}>{children}</Text>;
};
export const ButtonTextMedium = ({style, children}) => {
  return <Text style={[styles.ButtonTextMediumStyle, style]}>{children}</Text>;
};
